const { jsx: t, jsxs: l } = window.__OIKOS_SDK__.jsxRuntime, tt = {
  ...
  dry: "Dry",
  fan_only: "Fan"
}, mt = "Current", ft = "Target", yt = "Humidity", ht = "Outdoor", bt = "Fan", gt = "Turn on", xt = "Turn off", vt = "Entity unavailable", St = "Configure a climate.* entity in the card settings.", _t = {
  ...
  noEntity: St,
  settings: _t
}, { useState: Ct, useMemo: j } = window.__OIKOS_SDK__.React, { motion: C, AnimatePresence: zt } = window.__OIKOS_SDK__.framerMotion, { Power: Ot, PowerOff: Tt, Snowflake: $t, Flame: Et, Wind: P, Droplets: L, RefreshCcw: Ht, Plus: It, Minus: kt, Sun: Ft, Sparkles: V, AirVent: Wt } = window.__OIKOS_SDK__.icons, { useDashboard: Kt, useCardConfig: At, registerCardTranslations: Rt, useT: Mt } = window.__OIKOS_SDK__;
Rt("card-climatizzatore", { it: ut, en: wt });
const Dt = {
  entityId: "",
  // climate.X
  indoorTempEntity: "",
  ...
  off: { modeKey: "off", color: "#94a3b8", icon: Wt, bg: "rgba(148,163,184,.1)" },
  cool: { modeKey: "cool", color: "#06b6d4", icon: $t, bg: "rgba(6,182,212,.12)" },
  heat: { modeKey: "heat", color: "#ef4444", icon: Et, bg: "rgba(239,68,68,.12)" },
  heat_cool: { modeKey: "auto", color: "#8b5cf6", icon: V, bg: "rgba(139,92,246,.12)" },
  auto: { modeKey: "auto", color: "#8b5cf6", icon: V, bg: "rgba(139,92,246,.12)" },
...
function F(s, r = 1) {
  return s == null || !Number.isFinite(s) ? "—" : Math.abs(s) >= 100 ? s.toFixed(0) : s.toFixed(r);
}
function Vt({ cardId: s = "climatizzatore" }) {
  const { dark: r, getState: K, getFloat: g, getAttr: jt, callService: x, haStates: z } = Kt(), [o] = At(s, Dt), { t: c } = Mt("card-climatizzatore"), [v, A] = Ct(null), p = o.entityId, h = p ? z == null ? void 0 : z[p] : null, i = (h == null ? void 0 : h.state) ?? "unavailable", u = (h == null ? void 0 : h.attributes) ?? {}, a = i === "off" || i === "unavailable" || i === "unknown", O = o.indoorTempEntity ? g(o.indoorTempEntity) : null, U = O != null && Number.isFinite(O) ? O : u.current_temperature, m = u.temperature ?? u.target_temp, T = o.humidityEntity ? g(o.humidityEntity) : null, $ = T != null && Number.isFinite(T) ? T : u.current_humidity, E = u.min_temp ?? 16, H = u.max_temp ?? 32, G = u.hvac_modes ?? ["off", "cool", "heat", "auto", "dry", "fan_only"], I = u.fan_modes ?? null, y = u.fan_mode, k = o.outdoorTempEntity ? g(o.outdoorTempEntity) : null, _ = j(() => N(i), [i]), n = o.accentColor || _.color, q = o.label || u.friendly_name || "Climatizzatore", J = j(() => i !== "off" ? i : "cool", [i]), w = async (e, d) => {
    if (p) {
      A(e);
      try {
        await Promise.resolve(d()).catch((b) => console.error("[Climatizzatore]", e, b));
      } finally {
        setTimeout(() => A(null), 400);
      }
    }
  }, Q = () => w(
    "power",
    () => a ? x("climate", "set_hvac_mode", p, { hvac_mode: J }) : x("climate", "set_hvac_mode", p, { hvac_mode: "off" })
  ), X = (e) => w(
    "mode",
    () => x("climate", "set_hvac_mode", p, { hvac_mode: e })
  ), R = (e) => {
    if (m == null) return;
    const d = Math.min(H, Math.max(
      E,
      Math.round((m + e) / o.step) * o.step
    ));
    d !== m && w("temp", () => x("climate", "set_temperature", p, { temperature: d }));
  }, Y = (e) => w(
    "fan",
    () => x("climate", "set_fan_mode", p, { fan_mode: e })
  ), M = r ? "rgba(255,255,255,.92)" : "#0f172a", f = r ? "rgba(255,255,255,.5)" : "#64748b", D = r ? "rgba(255,255,255,.04)" : "#ffffff", S = r ? "rgba(255,255,255,.08)" : "#e2e8f0";
  return p ? /* @__PURE__ */ l(
    C.div,
    {
      layout: !0,
      style: {
        ...
        borderRadius: 18,
        background: D,
        border: `1px solid ${a ? S : `${n}40`}`,
        overflow: "hidden",
        boxShadow: a ? r ? "0 4px 20px rgba(0,0,0,.3)" : "0 2px 12px rgba(0,0,0,.05)" : `0 0 0 1px ${n}30, 0 8px 32px ${n}25`,
      ...
      children: [
        ...
        /* @__PURE__ */ l("div", { style: { position: "relative", display: "flex", alignItems: "center", gap: 10, marginBottom: 14 }, children: [
          /* @__PURE__ */ t(
            C.div,
            {
              animate: !a && i === "cool" ? { rotate: [0, 360] } : !a && i === "fan_only" ? { rotate: [0, 360] } : !a && i === "heat" ? { scale: [1, 1.08, 1] } : { scale: 1 },
              transition: !a && (i === "cool" || i === "fan_only") ? { duration: 4, repeat: 1 / 0, ease: "linear" } : { duration: 1.2, repeat: 1 / 0, ease: "easeInOut" },
              style: {
                width: 36,
                height: 36,
                borderRadius: 10,
              ...
              children: /* @__PURE__ */ t(_.icon, { size: 18, strokeWidth: 2 })
            }
          ),
          ...
          /* @__PURE__ */ t(
            "button",
            {
              ...
              style: {
                ...
                borderRadius: 10,
                cursor: "pointer",
                background: a ? r ? "rgba(255,255,255,.05)" : "#f1f5f9" : `${n}18`,
                border: `1px solid ${a ? S : `${n}50`}`,
                color: a ? f : n,
                display: "flex",
                alignItems: "center",
                justifyContent: "center",
              ...
              children: a ? /* @__PURE__ */ t(Ot, { size: 16, strokeWidth: 2.4 }) : /* @__PURE__ */ t(Tt, { size: 16, strokeWidth: 2.4 })
            }
          )
        ] }),
        ...
        ($ != null || k != null || y && o.showFan) && /* @__PURE__ */ l("div", { style: {
          display: "flex",
          gap: 8,
          marginBottom: 12,
          flexWrap: "wrap"
        }, children: [
          o.showHumidity && $ != null && /* @__PURE__ */ t(
            W,
            {
              dark: r,
          ...
          k != null && /* @__PURE__ */ t(
            ...
            {
              dark: r,
              icon: /* @__PURE__ */ t(Ft, { size: 11 }),
              value: `${F(k, 0)}°`,
              label: c("chipOutdoor")
            }
          ),
          o.showFan && y && /* @__PURE__ */ t(
            W,
            {
              dark: r,
        ...
        /* @__PURE__ */ t("div", { style: {
          ...
          return /* @__PURE__ */ l(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ t(Z, { size: 13, strokeWidth: b ? 2.4 : 2 }),
        ...
        o.showFan && I && I.length > 0 && !a && /* @__PURE__ */ t("div", { style: {
          display: "flex",
          gap: 4,
          flexWrap: "wrap",
          marginTop: 8
        ...
        /* @__PURE__ */ t(zt, { children: (i === "unavailable" || i === "unknown") && /* @__PURE__ */ l(
          C.div,
          {
            initial: { opacity: 0 },
            animate: { opacity: 1 },
            ...
            children: [
              /* @__PURE__ */ t(Ht, { size: 13, style: { animation: "spin 2s linear infinite" } }),
              c("unavailable")
            ]
          }
        ) })
...
function W({ dark: s, icon: r, value: K, label: g }) {
