...
export function buildEntityMap(prefix) {
  ...
  return {
    ...
    dndEntity:              sw('dnd'),
    cleanCarpetsFirstEntity: sw('clean_carpets_first'),
    carpetBoostEntity:      sw('carpet_boost'),
    selfCleanSwitchEntity:  sw('self_clean'),
    autoDryingEntity:       sw('auto_drying'),
    collisionAvoidanceEntity: sw('collision_avoidance'),
    autoRecleaningEntity:    sel('auto_recleaning'),
    floorDirectionEntity:    sw('floor_direction_cleaning'),
    stainAvoidanceEntity:    sw('stain_avoidance'),
